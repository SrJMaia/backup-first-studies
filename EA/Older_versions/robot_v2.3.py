...
while True:
    ...
    for i in events.values():
        ...
        """
        Fazer uma lista, passar por todas as posições abertas e ir adicionado
        o type de cadap osição aberta
        no final checar se ha 0 ou 1 dentro da lsita, se houver False
        se não, True
        """
