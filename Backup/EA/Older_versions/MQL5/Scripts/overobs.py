...
def preprocess_mt5(symbol,mt5, init= dt.datetime(2018, 1, 28, 13),end=dt.datetime.now(dt.timezone.utc), time_frame=mt5.TIMEFRAME_M5):
...
def diff_data(list_symbol):
   ...
   df2['sma'] = round(df2['sum'].rolling(sma_diff_period,min_periods=sma_min_period).sum()*100,0)
   return df2['sma']
...
data.to_csv('C:\\Users\\johnk\\AppData\\Roaming\\MetaQuotes\\Terminal\\D0E8209F77C8CF37AD8BF550E51FF075\\MQL5\\Files\\prices.csv')
